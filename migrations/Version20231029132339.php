 ...
 */
final class Version20231029132339 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book ADD author_id INT DEFAULT NULL, CHANGE published published TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book DROP author_id, CHANGE published published INT NOT NULL');
    }
}
